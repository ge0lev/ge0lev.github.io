...
* Using the following screenshots of the disassembly and the pseudocode of the function ![](/assets/img/malops-silent-authenticator/unix-setcred-return-1.png]] ![[unix-setcred-return-2.png)                                      we can see that the identifier is ***unix_setcred_return***.
